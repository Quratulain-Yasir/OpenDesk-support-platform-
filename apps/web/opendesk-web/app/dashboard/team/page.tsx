...
export default function TeamPage() {
  ...
  async function handleInvite(e: React.FormEvent) {
    ...
    setInviteMsg("")
    try {
      await api(`/workspaces/${wsId}/invite`, {
        method: "POST",
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {canManage && (
        <Card className="mb-6">
          <CardContent className="p-4">
            ...
            {inviteMsg && <p className="mt-2 text-xs text-green-600 break-all">{inviteMsg}</p>}
          </CardContent>
        </Card>
      )}
      ...
      {canManage && invites.length > 0 && (
        <div className="mb-6">
          <h3 className="text-sm font-semibold mb-2 text-muted-foreground">Pending Invitations</h3>
